...
<div class="page-body-wrapper default-menu default-menu">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-main-title">
                    <div>
                      <h6>Aid Amigo</h6>
                      <p>Fundraising & Crowd Funding</p>
                    </div>
                  </li>
                  <li class="sidebar-list">
                    <label class="badge badge-success">1</label><a class="sidebar-link sidebar-title" href="#"><i data-feather="home"></i><span >Dashboard              </span></a>
        ...
        <!-- <div class="sidebar-wrapper">
          <div>
            ...
            <div class="logo-icon-wrapper"><a href="index.php"><img class="img-fluid" src="../../assets/img/logo/AIDAMIGO_SVG_BACKGROUNDLESS.svg" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index.php"><img class="img-fluid" src="../../assets/img/logo/AIDAMIGO_SVG_BACKGROUNDLESS.svg" alt=""></a>
                    <div class="mobile-back text-end"><span>Back</span><i class="fa fa-angle-right ps-2" aria-hidden="true"></i></div>
                  </li>
