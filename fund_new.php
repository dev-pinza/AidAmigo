...
<main class="main">
				<!-- <section class="promo-primary">
					<picture>
						<source srcset="assets/img/cause_details.jpg" media="(min-width: 992px)"/><img class="img--bg" src="assets/img/cause_details.jpg" alt="img"/>
					</picture>
				...
				<!-- donation start-->
				<section class="section donation"><img class="donation__bg" src="assets/img/donation_img.png" alt="img"/>
					<div class="container">
						<div class="row">
							<div class="col-12">
								<div class="donation-item">
									<div class="donation-item__img"><img class="img--bg" src="assets/img/donation-item_img.jpg" alt="img"/></div>
									<div class="donation-item__body">
										...
										<form class="form donation-form" action="javascript:void(0);">
											...
											<!-- <div class="row margin-bottom">
												...
												<div class="col-12">
													<label class="form__radio-label"><img class="form__label-img" src="assets/img/paypal.png" alt="paypal"/>
													...
													<label class="form__radio-label"><img class="form__label-img" src="assets/img/klarna.png" alt="klarna"/>
													...
													<label class="form__radio-label"><img class="form__label-img" src="assets/img/visa.png" alt="visa"/>
									...
									<div class="horizontal-tabs__content">
														...
														<div class="row align-items-center">
															<div class="col-lg-7">
																<div class="donor-item__info">
																	<div class="donor-item__img"><img class="img--bg" src="assets/img/face_1.jpg" alt="face"/></div>
												...
												<div class="col-md-6 col-xl-4">
													...
													<div class="donor-item">
														<div class="row align-items-center">
															<div class="col-lg-7">
																<div class="donor-item__info">
																	<div class="donor-item__img"><img class="img--bg" src="assets/img/face_2.jpg" alt="face"/></div>
																	<div class="donor-item__description">
												...
												<div class="col-md-6 col-xl-4">
													...
													<div class="donor-item">
														<div class="row align-items-center">
															<div class="col-lg-7">
																<div class="donor-item__info">
																	<div class="donor-item__img"><img class="img--bg" src="assets/img/face_3.jpg" alt="face"/></div>
																	<div class="donor-item__description">
												...
												<div class="col-md-6 col-xl-4">
													...
													<div class="donor-item">
														<div class="row align-items-center">
															<div class="col-lg-7">
																<div class="donor-item__info">
																	<div class="donor-item__img"><img class="img--bg" src="assets/img/face_4.jpg" alt="face"/></div>
																	<div class="donor-item__description">
												...
												<div class="col-md-6 col-xl-4">
													...
													<div class="donor-item">
														<div class="row align-items-center">
															<div class="col-lg-7">
																<div class="donor-item__info">
																	<div class="donor-item__img"><img class="img--bg" src="assets/img/face_5.jpg" alt="face"/></div>
																	<div class="donor-item__description">
												...
												<div class="col-md-6 col-xl-4">
													...
													<div class="donor-item">
														<div class="row align-items-center">
															<div class="col-lg-7">
																<div class="donor-item__info">
																	<div class="donor-item__img"><img class="img--bg" src="assets/img/face_6.jpg" alt="face"/></div>
																	<div class="donor-item__description">
										...
										<div class="horizontal-tabs__item" id="horizontal-tabs__item-4">
											<div class="gallery-simple">
												<div class="row offset-30">
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_1.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_1.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_2.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_2.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_3.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_3.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_4.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_4.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_5.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_5.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_6.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_6.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_7.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_7.jpg" alt="img"/></a></div>
													<div class="col-12 col-sm-6 col-lg-4 col-xl-3"><a class="gallery-simple__item" href="assets/img/ig_8.jpg" data-fancybox="simple-gallery"><img class="img--bg" src="assets/img/ig_8.jpg" alt="img"/></a></div>
												</div>
											</div>
										</div>
									</div>
				...
				<!-- causes start-->
				<!-- <section class="section causes causes--style-2"><img class="causes__bg" src="assets/img/causes_img-2.png" alt="img"/>
					<div class="container">
