      ...
      <div class="error-wrapper">
        <div class="container">
          ...
          <div class="error-heading">
            <h2 class="headline font-success">Thank You!</h2>
          </div>
          <div class="col-md-8 offset-md-2">
            <p class="sub-content">You have successfully registered with GrowFund! please confirm your E-mail Address & Login</p>
          </div>
          <div><a class="btn btn-success-gradien btn-lg" href="login.php">Login</a></div>
        </div>
      </div>
      <!-- error-403 end-->
    </div>
